...
export const SPAIndex = () => {
	return (
		<div>
			...
			<p>
				You can edit this text in <code>src/components/SPA.tsx</code> and see the changes without
				reloading the entire page-- but only if you're running the Vite dev server that QGP set up.
			</p>
